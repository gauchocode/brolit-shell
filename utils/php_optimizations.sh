...
echo -e ${MAGENTA}"********* RUNNING PHP OPTIMIZATION TOOL  *********"${ENDCOLOR}
#echo " > RUNNING PHP OPTIMIZATION TOOL" >>$LOG
...
echo -e ${GREEN}"PM_PROCESS_IDDLE_TIMEOUT: ${PM_PROCESS_IDDLE_TIMEOUT}"${ENDCOLOR}
echo -e ${GREEN}"*******************************************"${ENDCOLOR}
...
while true; do
  ...
  [Yy]*)
    ...
    ;;
  [Nn]*)
    echo -e ${YELLOW}"Skipping optimization ..."${ENDCOLOR}
    break
    ;;
