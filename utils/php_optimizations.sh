...
php_fpm_optimizations() {
  ...
  log_event "info" "**************************************************" "true"
  log_event "info" "****************** SERVER INFO  ******************" "true"
  log_event "info" "**************************************************" "true"
  ...
  log_event "info" "**************************************************" "true"
  log_event "info" "************* PHP-FPM OPTIMAL CONFIG *************" "true"
  log_event "info" "**************************************************" "true"
  ...
  log_event "info" "**************************************************" "true"
  log_event "info" "************* PHP-FPM ACTUAL CONFIG **************" "true"
  log_event "info" "**************************************************" "true"
...
log_event "info" "********* RUNNING PHP OPTIMIZATION TOOL  *********" "true"
